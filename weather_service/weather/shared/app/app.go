...
import (
	...
	endpointsCity "github.com/hgtpcastro/go-expert-lab-google-cloud-run/weather_service/weather/zip_code/features/getting_city_by_zip_code/v1/endpoints"
	endpointsWeather "github.com/hgtpcastro/go-expert-lab-google-cloud-run/weather_service/weather/zip_code/features/getting_weather_by_zip_code/v1/endpoints"
...
func (a *App) Run() {
	...
	e.GetEchoInstance().GET("//", func(c echo.Context) error {
		return c.String(http.StatusOK, "weather service is running")
	})
